              ...
              return (
                <motion.button
                  ...
                  className="
                    ...
                    to-[#8f5548]
                    shadow-lg
                    shadow-[rgba(160,100,80,0.35)]
                    hover:shadow-xl
                    hover:shadow-[rgba(160,100,80,0.45)]
                    focus:ring-[rgba(160,100,80,0.5)]
                    transition-all
                    duration-200
                    focus:outline-none
                    focus:ring-2
            ...
            return (
              <motion.button
                ...
                className={`
                  ...
                  focus:outline-none
                  focus:ring-2
                  focus:ring-[rgba(180,120,100,0.4)]
                  focus:ring-offset-2
                  ${isActive 
                    ? 'bg-[rgba(240,210,200,0.5)] text-[#6b3a30]'
                    : 'hover:bg-[rgba(240,210,200,0.3)] active:bg-[rgba(240,210,200,0.5)]'
                  }
                `}
                aria-label={button.label}
              >
                ...
                <Icon 
                  className={`
                    ...
                    ${isActive ? 'text-[#6b3a30]' : 'text-[#9c6050]'}
                  `}
                  strokeWidth={1.5}
                />
