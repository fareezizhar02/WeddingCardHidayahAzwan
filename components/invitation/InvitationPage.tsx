...
const onTouchMove = (e: TouchEvent) => {
  ...
  const handleEnter = async () => {
    ...
    if (audioRef.current) {
      try {
        audioRef.current.currentTime = 189; // Music start from 2:52
  ...
  return (
    <div className="relative w-full overflow-x-hidden isolate">
      <audio ref={audioRef} loop preload="auto">
        <source src="/music/MENAMAKANMU_CINTA.mp3" type="audio/mpeg" />
      </audio>
      ...
      <div className="fixed inset-0 -z-10 bg-gradient-to-br from-cream-100 via-amber-50/50 to-stone-100">
        <WatercolorBackground idPrefix="page" />
      </div>
        ...
        <AnimatePresence mode="wait">
          {hasEntered && currentPage === "cover" && (
            ...
            >
              ...
              <div className="min-h-screen flex items-start justify-center px-0 sm:px-6 md:px-8 py-2">                <ContentCard sectionRefs={sectionRefs} onUserScrollDoa={() => {}} />
              </div>

              <div className="flex items-center justify-center py-0 sm:py-2">
