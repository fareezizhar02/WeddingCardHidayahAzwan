...
export default function LocationSheet({ isOpen, onClose }: LocationSheetProps) {
  const title = 'Lokasi'
  const address = `Dara Glass Hall,
  Pt 1046, Lorong Pengkalan Penambang, 
  Kampung Pendek, 15100 Kota Bharu, Kelantan`

  const WAZE_URL = 'https://waze.com/ul/hw30dqp63d?navigate=yes&zoom=17'
  const GMAPS_URL = 'https://maps.app.goo.gl/kErt8vG4eThFbxjq9?g_st=iw'
